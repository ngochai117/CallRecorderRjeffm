package com.android.ictteam.callrecorderrjeffm.apdater;
...
public abstract class SectionedRecyclerViewAdapter <VH extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<VH>{
     ...
     * @param holder
     * @param section is section index.
     * @param relativePosition is index in this section.
     * @param absolutePosition is index out of all non-header items.
     */
